...
$$L\approx\frac{K_0}{3}\cdot(1+''corrections'')$$
...
$$E^{\textrm{kin}}(\rho,\delta)=\frac{1}{\rho}\underbrace{\frac{2}{(2\pi)^3}\sum_{J=\rm{n,p}}\int_0^{\infty}
...
$$E_{\rm{sym}}(\rho)=\frac{k_{\rm{F}}^2}{6E_{\rm{F}}^{\ast}}+\frac{\Sigma_{\rm{S}}^{\rm{sym}}(\rho,k_{\rm{F}})}{2}\frac{M_0^{\ast}}{E_{\rm{F}}^{\ast}}+\frac{\Sigma_{\rm{V}}^{\rm{sym}}(\rho,k_{\rm{F}})}{2}$$
