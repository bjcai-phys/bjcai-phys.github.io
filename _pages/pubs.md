...
$$ M_{\rm{NS}}\sim \frac{\Pi_{\rm{c}}^{3/2}}{\sqrt{\varepsilon_{\rm{c}}}},R\sim \frac{\Pi_{\rm{c}}^{1/2}}{\sqrt{\varepsilon_{\rm{c}}}},\xi\approx\Pi_{\rm{c}}=\frac{2{\rm X}}{1+3{\rm X}^2+4{\rm X}},{\rm X}=P_{\rm{c}}/\varepsilon_{\rm{c}}$$
