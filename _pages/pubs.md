...
$$ M_{\rm{NS}}\sim \frac{1}{\sqrt{\varepsilon_{\rm{c}}}}\left(\frac{{\rm X}}{1+3{\rm X}^2+4{\rm X}}\right)^{3/2},R\sim \frac{1}{\sqrt{\varepsilon_{\rm{c}}}}\left(\frac{{\rm X}}{1+3{\rm X}^2+4{\rm X}}\right)^{1/2},\xi=\frac{M_{\rm{NS}}}{R}\approx\frac{2{\rm X}}{1+3{\rm X}^2+4{\rm X}},{\rm X}=P_{\rm{c}}/\varepsilon_{\rm{c}}$$
